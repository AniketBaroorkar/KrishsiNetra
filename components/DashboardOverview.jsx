    ...
    <section className="gov-page">
      <div className="gov-page-header">
        <div>
          ...
          <h1>KrishiNetra Admin Dashboard</h1>
          <p>Monitor farmers, geo-tagged crop photos, claims, risk scores, crop distribution, and disaster alerts.</p>
        </div>
      ...
      <div className="dashboard-insight-grid">
        <section className="gov-card">
          <div className="friendly-card-heading"><h2>Risk Distribution</h2></div>
        ...
        <section className="gov-card">
          <div className="friendly-card-heading"><h2>Crop Distribution</h2></div>
          <div className="chip-grid">{cropSummary.map((item) => <span className="crop-chip" key={item.crop}>{item.crop}: {item.count}</span>)}</div>
        </section>
        <section className="gov-card">
          <div className="friendly-card-heading"><h2>District-wise Farmer Summary</h2></div>
